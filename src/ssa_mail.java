...
public class ssa_mail {
   public static void main(String[] args) {
      // Recipient's email ID needs to be mentioned.
      String to = "PH00487322@TechMahindra.com";
      ...
      try {
       ...
       sb.append("<html><head></head><body><p>Dear User,</p><p>The Requested SR-SR0001 is successfully completed and find the below details.</p> <style> table, td, th { border: 1px solid black; } table { border-collapse: collapse;} </style> <table height: 90px; width=\"100%\" cellspacing = \"10\"> <tr> <th bgcolor=\"#ff6666\">S.no</th> <th bgcolor=\"#ff6666\">Remarks</th><th bgcolor=\"#ff6666\">Url</th></tr><tr>  <td>1</td> <td>Jira</td><td>http://INBASDPC05678:8899/{ProjectName}</td> </tr><tr><td>2</td> <td>SCM Repository URL</td><td>http://admin@10.53.67.52:7990/scm/os/{projectname}.git</td> </tr><tr> <td>3</td> <td>Pipeline in Jenkins</td><td>http://bsdpcs2964481:9093/jenkins/job/{pipelinename}</td> </tr> </table> <p>This is a SSA  generated mail. Please do not reply to this mail.<br> For any queries please raise a request.</p><p>Thanks, <br>SSA DevOps Team.</p> </body></html>");
          //sb.append("<html><body><p>Dear User,<br></p> <p>The Requested SR-SR0001 is successfully completed and find the below details.</p> <style>table, td, th { border: 1px solid black; }table {border-collapse: collapse;} </style><table height: 90px;  width=\"100%\" cellspacing = \"10\"> <tr><th bgcolor=\"#ff6666\">S.no</th><th bgcolor=\"#ff6666\">Remarks</th><th bgcolor=\"#ff6666\">Url</th></tr> <tr><td>1</td> <td>Jira</td><td>http://INBASDPC05678:8899/{ProjectName}</td> </tr><tr> <td>2</td> <td>SCM Repository URL</td><td>http://admin@10.53.67.52:7990/scm/os/{projectname}.git</td> </tr> <tr> <td>3</td> <td>Pipeline in Jenkins</td><td>http://bsdpcs2964481:9093/jenkins/job/{pipelinename}</td></tr> </table></body> </html>");
         		//+ "<pre> This is a SSA  generated mail. Please do not reply to this mail.<br> For any queries please raise a request. <br>Thanks,<br>SSA DevOps Team </pre> </body> </html>");
       /*  Message msg = message;
      ...
      // messageBodyPart.setText(sb.toString(),"text/html");
